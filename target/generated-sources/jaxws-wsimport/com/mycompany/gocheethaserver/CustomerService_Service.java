 ...
 * 
 */
@WebServiceClient(name = "CustomerService", targetNamespace = "http://gocheethaserver.mycompany.com/", wsdlLocation = "http://localhost:25977/GoCheethaServer/CustomerService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERSERVICE_QNAME = new QName("http://gocheethaserver.mycompany.com/", "CustomerService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:25977/GoCheethaServer/CustomerService?wsdl");
    ...
    public CustomerService getCustomerServicePort() {
        return super.getPort(new QName("http://gocheethaserver.mycompany.com/", "CustomerServicePort"), CustomerService.class);
    }
    ...
    public CustomerService getCustomerServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://gocheethaserver.mycompany.com/", "CustomerServicePort"), CustomerService.class, features);
    }
